...
extension TagsCloudDataSource: UICollectionViewDelegateFlowLayout {
    func collectionView(_ collectionView: UICollectionView,
        ...
        let size = getSizeForTag(tag: tag, sectionInset: sectionInset, collectionViewWidth: width)
        return size
    }

    func getSizeForTag(tag: Tag, sectionInset: UIEdgeInsets, collectionViewWidth: CGFloat) -> CGSize {
